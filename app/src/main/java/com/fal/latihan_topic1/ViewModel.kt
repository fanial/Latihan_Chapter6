...
import com.fal.latihan_topic1.workers.BlurWorkers
import com.fal.latihan_topic1.workers.KEY_IMAGE_URI
...
class BlurViewModelFactory(private val application: Application) :
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return if (modelClass.isAssignableFrom(com.fal.latihan_topic1.ViewModel::class.java)) {
